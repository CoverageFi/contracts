...
contract ScriptETHSepolia is Script {
    ...
    function run() external {
        ...
        vm.startBroadcast();
        crossChainSender = CrossChainSender(0x497047952A7F275B48D097cB0e8b7Ad843100a2A);
        uint256 fee = crossChainSender.quoteCrossChainDeposit(helperConfig.getBaseSepoliaConfig().wormholeChainId);
        IERC20(helperConfig.getSepoliaConfig().usdc).approve(address(crossChainSender), 1 * 1e6);
